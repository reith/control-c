...
?>
<script src='/script/login.js.php'></script>
  <form id='loginForm'>
  <fieldset>
  ...
  <table style="width: 400px;">
    ...
    <li><?php echo _("Have not any account yet?")?>&nbsp;<a href='<?=Routing::genURL('signup')?>' ><?php echo _("Sign up");?></a></li>
...
login('#loginForm', '<?=Routing::genProc('signin')?>');
